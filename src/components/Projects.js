        ...
        <table>
          <tr>
            <td>
              ...
              <p className="smaller-text">A Web Scraper written in C# using Selenium</p>
            </td>
            <td>
              ...
              <p className="smaller-text">Completed problem sets from Harvard's CS50 Course</p>
            </td>
          </tr>
          <tr>
            <td>
              ...
              <p className="smaller-text">Some Test Driven Development practice using Visual Studio and NUnit</p>
            </td>
            <td>
              ...
              <p className="smaller-text">A very simple weather API script using OpenWeatherMap</p>
            </td>
          </tr>
        </table>
      </div>
